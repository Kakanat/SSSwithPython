...
write_file_from_time_signal(mvdr_out, "./results/mvdr_out_2spk.wav", sample_rate)

fig = plt.figure(figsize=(10,4))
spectrum, freqs, t, im = plt.specgram(mvdr_out, NFFT=512, noverlap=512/16*15, Fs=wav.getframerate(), cmap="gray")

...
#畳み込んだ波形をファイルに書き込む
write_file_from_time_signal(multi_conv_data[0,n_noise_only:]*np.iinfo(np.int16).max/20.,"./results/maxsnr_in.wav",sample_rate)
...
#ファイルに書き込む
write_file_from_time_signal(maxsnr_out[n_noise_only:],"./results/maxsnr_out.wav",sample_rate)
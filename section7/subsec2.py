...
#         y_left=(amp_ratio > 1.).astype(float)*x_left

#         y_right=(amp_ratio <= 1.).astype(float)*x_right

#     else:
#         #位相差を用いた分離
#         phase_difference=np.angle(x_left/x_right)
        
#         y_left=(phase_difference > 0.).astype(float)*x_left
        
#         y_right=(phase_difference <= 0.).astype(float)*x_right
...
# #畳み込んだ波形をファイルに書き込む
# write_file_from_time_signal(multi_conv_data_left_no_noise[0,:]*np.iinfo(np.int16).max/20.,"./results/far_left_clean.wav",sample_rate)

# #畳み込んだ波形をファイルに書き込む
# write_file_from_time_signal(multi_conv_data_right_no_noise[1,:]*np.iinfo(np.int16).max/20.,"./results/far_right_clean.wav",sample_rate)

# #畳み込んだ波形をファイルに書き込む
# write_file_from_time_signal(multi_conv_data[0,:]*np.iinfo(np.int16).max/20.,"./results/far_in_left.wav",sample_rate)
# write_file_from_time_signal(multi_conv_data[1,:]*np.iinfo(np.int16).max/20.,"./results/far_in_right.wav",sample_rate)
...
# #ファイルに書き込む
# write_file_from_time_signal(y_phase_left*np.iinfo(np.int16).max/20.,"./results/far_sparse_phase_left.wav",sample_rate)
# write_file_from_time_signal(y_phase_right*np.iinfo(np.int16).max/20.,"./results/far_sparse_phase_right.wav",sample_rate)
# write_file_from_time_signal(y_amp_left*np.iinfo(np.int16).max/20.,"./results/far_sparse_amp_left.wav",sample_rate)
# write_file_from_time_signal(y_amp_right*np.iinfo(np.int16).max/20.,"./results/far_sparse_amp_right.wav",sample_rate)
...
#畳み込んだ波形をファイルに書き込む
write_file_from_time_signal(multi_conv_data_left_no_noise[0,:]*np.iinfo(np.int16).max/20.,"./results/doa_left_clean.wav",sample_rate)

#畳み込んだ波形をファイルに書き込む
write_file_from_time_signal(multi_conv_data_right_no_noise[0,:]*np.iinfo(np.int16).max/20.,"./results/doa_right_clean.wav",sample_rate)

#畳み込んだ波形をファイルに書き込む
write_file_from_time_signal(multi_conv_data[0,:]*np.iinfo(np.int16).max/20.,"./results/doa_in_left.wav",sample_rate)
write_file_from_time_signal(multi_conv_data[0,:]*np.iinfo(np.int16).max/20.,"./results/doa_in_right.wav",sample_rate)
...
#ファイルに書き込む
write_file_from_time_signal(y_doa_left*np.iinfo(np.int16).max/20.,"./results/sparse_doa_left.wav",sample_rate)
write_file_from_time_signal(y_doa_right*np.iinfo(np.int16).max/20.,"./results/sparse_doa_right.wav",sample_rate)

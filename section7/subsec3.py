...
#畳み込んだ波形をファイルに書き込む
write_file_from_time_signal(multi_conv_data_left_no_noise[0,:]*np.iinfo(np.int16).max/20.,"./results/doa_bf_left_clean.wav",sample_rate)

#畳み込んだ波形をファイルに書き込む
write_file_from_time_signal(multi_conv_data_right_no_noise[0,:]*np.iinfo(np.int16).max/20.,"./results/doa_bf_right_clean.wav",sample_rate)

#畳み込んだ波形をファイルに書き込む
write_file_from_time_signal(multi_conv_data[0,:]*np.iinfo(np.int16).max/20.,"./results/doa_bf_in_left.wav",sample_rate)
write_file_from_time_signal(multi_conv_data[0,:]*np.iinfo(np.int16).max/20.,"./results/doa_bf_in_right.wav",sample_rate)
...
#ファイルに書き込む
write_file_from_time_signal(y_sparse[0,...]*np.iinfo(np.int16).max/20.,"./results/sparse_doa_sparse_left.wav",sample_rate)
write_file_from_time_signal(y_sparse[1,...]*np.iinfo(np.int16).max/20.,"./results/sparse_doa_sparse_right.wav",sample_rate)
write_file_from_time_signal(y_dsbf[0,...]*np.iinfo(np.int16).max/20.,"./results/sparse_doa_dsbf_left.wav",sample_rate)
write_file_from_time_signal(y_dsbf[1,...]*np.iinfo(np.int16).max/20.,"./results/sparse_doa_dsbf_right.wav",sample_rate)
write_file_from_time_signal(y_mvdr[0,...]*np.iinfo(np.int16).max/20.,"./results/sparse_doa_mvdr_left.wav",sample_rate)
write_file_from_time_signal(y_mvdr[1,...]*np.iinfo(np.int16).max/20.,"./results/sparse_doa_mvdr_right.wav",sample_rate)
write_file_from_time_signal(y_mvdr2[0,...]*np.iinfo(np.int16).max/20.,"./results/sparse_doa_mvdr2_left.wav",sample_rate)
write_file_from_time_signal(y_mvdr2[1,...]*np.iinfo(np.int16).max/20.,"./results/sparse_doa_mvdr2_right.wav",sample_rate)
write_file_from_time_signal(y_max_snr[0,...]*np.iinfo(np.int16).max/20.,"./results/sparse_doa_max_snr_left.wav",sample_rate)
write_file_from_time_signal(y_max_snr[1,...]*np.iinfo(np.int16).max/20.,"./results/sparse_doa_max_snr_right.wav",sample_rate)
write_file_from_time_signal(y_mwf[0,...]*np.iinfo(np.int16).max/20.,"./results/sparse_doa_mwf_left.wav",sample_rate)
write_file_from_time_signal(y_mwf[1,...]*np.iinfo(np.int16).max/20.,"./results/sparse_doa_mwf_right.wav",sample_rate)
